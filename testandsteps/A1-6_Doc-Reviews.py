...
print("Bitte schließen sie das Pop-Up um zu diesem Fenster zurückzukehren und das Programm zu beenden.")
...
print(" ")
print("""Die neue Quelle zeigt ein deutlich verbessertes Ergebnis.
Dass bei Rezensionen natürlich die Worte "Arzt" und "Dr." zentral sind ist logisch. 
Aber es zeigen sich besonders in der Wortwolke zahlreiche relevante Begriffe die einen Schluss auf relevante Themen wie "Kompetenz", "Termin", "Zufriedenheit" und "Beratung" ermöglichen, um nur einige wenige zu nennen.
Ähnlich ist dies im Beschwerdemanagement einer Kommune/Stadt/Gemeinde zu erwarten.
Auch die reduzierte Durchlaufdauer der deutlich kürzeren Elemente sticht hervor.""")
